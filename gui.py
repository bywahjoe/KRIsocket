...
st1=Radiobutton(window,text='R2-GOL',variable=strgy,width=5,height=2,value=1,bg='black',fg='white',indicatoron=0,selectcolor='red',font='Arial 12 italic bold')
st2=Radiobutton(window,text='R1-GOL',variable=strgy,width=5,height=2,value=2,bg='black',fg='white',indicatoron=0,selectcolor='red',font='Arial 12 italic bold')
st3=Radiobutton(window,text='R2-CORNER',variable=strgy,width=5,height=2,value=3,bg='black',fg='white',indicatoron=0,selectcolor='red',font='Arial 12 italic bold')
...
b2=Button(window,text='DESTROYCV',command=lambda: multi_send('C2'),width=10,height=2,bg='#1D9DCE',font='Arial 10 bold',fg='white')
